    ...
    <body style="background-color: lightslategrey ;">
        ...
        <div class="px-4 my-5 text-center">
            ...
            <div class="card">
                <div class="container">
                    <!-- Formulario de ingreso de informacion del coductor para la base de datos -->
                    <form action="../controller/conductorcontroller.php" method="POST">
                        <div class="row" style="padding-top: 25px;">
                            ...
                            <input type="hidden" name="addconductor">
                        </div>
